...
//				.build();
//		given(hotelRepository.save(cut)).willReturn(cut);
//		Hotel updatedHotel = hotelServiceImpl.updateHotel(1L,cut);
//		assertEquals(cut.getName(),updatedHotel.getName());
//	}
...
//	@Test
//	void canUpdateAHotel() {
//		// create a new hotel entity in the database with some initial values
...
//
//		// create an updated hotel entity with the desired new values
//		Hotel updatedHotel = Hotel.builder()
//				.id(originalHotel.getId())
//				.name("New Hotel Name")
//				.shortDescription("New Short Description")
//				.longDescription("New Long Description")
//				.imageLink("new-hotel.png")
...
//				.build();
//
//		// call the updateHotel method of the service with the id of the original hotel and the updated hotel entity
//		Hotel result = hotelServiceImpl.updateHotel(originalHotel.getId(), updatedHotel);
//
//		// assert that the returned hotel has the expected values
//		assertEquals(updatedHotel.getName(), result.getName());
//		assertEquals(updatedHotel.getShortDescription(), result.getShortDescription());
//		assertEquals(updatedHotel.getLongDescription(), result.getLongDescription());
//		assertEquals(updatedHotel.getImageLink(), result.getImageLink());
//		assertEquals(updatedHotel.getLocation(), result.getLocation());
//		assertEquals(updatedHotel.getExperience(), result.getExperience());
//		assertEquals(updatedHotel.getPool(), result.getPool());
//		assertEquals(updatedHotel.getPrice(), result.getPrice());
//	}
